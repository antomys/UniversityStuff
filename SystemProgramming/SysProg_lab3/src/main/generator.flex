...
<YYINITIAL> {
  ...
  /* keywords */
   ...
   "boolean"                       { return symbol(yytext(),Lexem.keyword); }
   "enum"                     { return symbol(yytext(),Lexem.keyword); }
   "int"                           { return symbol(yytext(),Lexem.keyword); }
   ...
   "byte"                      { return symbol(yytext(),Lexem.keyword); }
   "extends"                      { return symbol(yytext(),Lexem.keyword); }
   "long"                          { return symbol(yytext(),Lexem.keyword); }
   ...
   "char"                          { return symbol(yytext(),Lexem.keyword); }
   ...
   "typeof"			        { return symbol(yytext(),Lexem.keyword); }
   ...
   "delete"                        { return symbol(yytext(),Lexem.keyword); }
   ...
   "with"                           { return symbol(yytext(),Lexem.keyword); }
   "double"                       { return symbol(yytext(),Lexem.keyword); }
   ...
   /*types*/
    ...
    "undefined"                          { return symbol(yytext(),Lexem.types); }
    "number"                          { return symbol(yytext(),Lexem.types); }
    "string"                          { return symbol(yytext(),Lexem.types); }
    "bigInt"                          { return symbol(yytext(),Lexem.types); }
    "symbol"		            	{ return symbol(yytext(),Lexem.types); }
    "function"		            	{ return symbol(yytext(),Lexem.types); }
